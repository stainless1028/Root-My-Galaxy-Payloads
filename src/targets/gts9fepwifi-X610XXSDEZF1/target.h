 ...
 * ------------------------------------------------------------------------- */
#define BUILD_VARIANT_LABEL "gts9fepwifi-X610XXSDEZF1-app"
#define PHYS_P0_ORACLE 1
#define SLIDE_ROUTE SLIDE_ROUTE_FPSIMD

#ifndef BUILD_FINGERPRINT
#define BUILD_FINGERPRINT \
  "samsung/gts9fepwifixx/gts9fepwifi:16/BP4A.251205.006/X610XXSDEZF1:user/release-keys"
#endif
...
#define P0_FINGERPRINT_HEADER \
  "targets/gts9fepwifi-X610XXSDEZF1/p0_fingerprint.h"
...
#define KMALLOC_CACHES_OFF 0x01b04ef0ULL
#define ANON_PIPE_BUF_OPS_OFF 0x01913060ULL
...
#define ASHMEM_FOPS_OFF 0x01ab3e88ULL
...
/* --- slide leak symbols ---------------------------------------------------- */
#define SLIDE_NFULNL_LOGGER_NAME_OFF 0x017fde8cULL
